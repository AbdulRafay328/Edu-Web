    ...
    <>
      <div className="flex justify-center items-center">
        <div className="flex flex-col justify-center items-center">
          ...
          <div className=" my-10 text-2xl text-slate-700 font-normal xs:w-[287px] shadow-xl shadow-black h-96 md:w-[700px] flex flex-col">
            <div className=" px-5 flex mt-5 justify-center items-start flex-col">
              <div>Registration Number*</div>
              <input
                className="border-[1px] xs:w-[249px] md:w-[660px] bg-slate-200 rounded-lg w-[660px] mt-2 font-medium text-xl p-3 border-gray-700"
                type="text"
