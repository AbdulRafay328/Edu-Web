...
function Main(){
    return(
        <>
        <div className=" mt-16 text-4xl text-center px-5 text-[#044E83] font-bold">
          Certified Cloud Applied Generative AI Engineer (GenEng) and
          Solopreneur Developing Billion-Dollar Valued Developers and
          Solopreneurs
        </div>

        <p className="px-5 text-justify text-xl text-gray-600 font-medium mt-10">
        ...
        <div className="flex items-center px-5 mt-9 justify-between">
          <Image
